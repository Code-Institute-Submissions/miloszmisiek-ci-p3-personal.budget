...
# Known Bugs
Most of bugs were found using PEP8 validator which are documented in section above. During code development all bugs were caught during development process.
